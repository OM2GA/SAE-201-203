            ...
            <div class="login-container">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/casque_vr.jpg" class="card-img-top" alt="Casque VR">
                            <div class="card-body">
                                <h5 class="card-title">Casque VR</h5>
                                <p class="card-text">Visualisation immersive pour projets 3D et simulations.</p>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/webcam.jpg" class="card-img-top" alt="Webcam">
                            <div class="card-body">
                                <h5 class="card-title">Webcam</h5>
                                <p class="card-text">Pour faire ses meilleurs réunions.</p>
                                <a href="reserver.html" class="btn btn-primary">Réserver</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/drone.jpg" class="card-img-top" alt="Drone">
                            <div class="card-body">
                                <h5 class="card-title">Drone</h5>
                                <p class="card-text">Pour filmer votre environnement depuis le ciel.</p>
                                <a href="reserver.html" class="btn btn-primary">Réserver</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/microphone.jpg" class="card-img-top" alt="Microphone">
                            <div class="card-body">
                                <h5 class="card-title">Microphone</h5>
                                <p class="card-text">Enregistrement audio de qualité pour podcasts ou vidéos.</p>
                                <a href="reserver.html" class="btn btn-primary">Réserver</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/casque et manettes vr.jpg" class="card-img-top" alt="Casque et manettes vr ">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/casque micro.jpg" class="card-img-top" alt="Casque micro">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/go pro.jpg" class="card-img-top" alt="go pro">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/trépied haut.jpg" class="card-img-top" alt="trépied haut ">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/trépied bas.jpg" class="card-img-top" alt="trépied bas">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/vidéo projecteur.jpg" class="card-img-top" alt="vidéo projecteur">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <img src="../images/caméra 360°.jpg" class="card-img-top" alt="caméra 360° ">
                            <div class="card-body">
