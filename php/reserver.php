            ...
            <div class="login-container">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="materiel" required>
                            <option value="">-- Sélectionnez un matériel --</option>
                            <option>Casque VR</option>
                            <option>Caméra 360°</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="horaire" required>
                            <option value="">-- Choisissez un créneau --</option>
                            <option>08h30 - 10h30</option>
                            <option>10h45 - 12h45</option>
                            <option>13h45 - 15h45</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="motif" rows="3" placeholder="Indiquez le but de votre réservation" required></textarea>
                    </div>

                    <div class="form-group">
                        <label for="etudiants">Autres étudiants concernés</label>
                        <input type="text" class="form-control" id="etudiants" placeholder="Ex: prénom nom, prénom nom...">
                    </div>

                    <div class="form-group">
                        <label for="commentaire">Commentaires</label>
                        <textarea class="form-control" id="commentaire" rows="2" placeholder="Commentaires additionnels (optionnel)"></textarea>
                    </div>
