...
<head>
    <meta charset="UTF-8">
    <title>Accueil Agent | Emprunt</title>
    ...
    <div class="main-container">
        <div class="container text-center">
            <div class="login-container">
                <h2 class="mb-4">Bienvenue sur votre espace agent</h2>
                <p class="mt-4">Consultez les réservations validées afin de gérer la remise du matériel ou des clés.</p>

                <div class="row mt-5">
                    <div class="col-md-6 mb-3">
                        <a href="reservations_validees.php" class="btn btn-primary btn-block">Réservations validées</a>
                    </div>
                    <div class="col-md-6 mb-3">
