    ...
    <div class="main-container">
        <div class="container text-center">
            <div class="login-container">
                <h2>Bienvenue sur l'espace de réservation</h2>
                <p class="mt-4">Vous êtes connecté avec succès !</p>

                <div class="row mt-5">
                    <div class="col-md-6 mb-3">
                        <a href="reserver.php" class="btn btn-primary btn-block">Faire une réservation</a>
                    </div>
                    <div class="col-md-6 mb-3">
                        <a href="materiel.php" class="btn btn-primary btn-block">Voir le matériel disponible</a>
                    </div>
                    <div class="col-md-6 mb-3">
                        <a href="historique.php" class="btn btn-primary btn-block">Mon historique</a>
                    </div>
                    <div class="col-md-6 mb-3">
